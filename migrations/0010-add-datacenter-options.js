    ...
    pets.insertOne({
        "value": {
            ...
            baser: {
                ...
                'OpenStack': [],
                'Azure': [
                    {region: "eastasia", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "southeastasia", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "centralus", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "eastus", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "eastus2", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "westus", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "northcentralus", zones: []},
                    {region: "southcentralus", zones: []},
                    {region: "northeurope", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "westeurope", zones: ["Zone 1", "Zone 2", "Zone 3"]},
                    {region: "japanwest", zones: []},
                    {region: "japaneast", zones: []},
                    {region: "brazilsouth", zones: []},
                    {region: "australiaeast", zones: []},
                    {region: "australiasoutheast", zones: []},
                    {region: "southindia", zones: []},
                    {region: "centralindia", zones: []},
                    {region: "westindia", zones: []},
                    {region: "canadacentral", zones: []},
                    {region: "canadaeast", zones: []},
                    {region: "uksouth", zones: []},
                    {region: "ukwest", zones: []},
                    {region: "westcentralus", zones: []},
                    {region: "westus2", zones: []},
                    {region: "koreacentral", zones: []},
                    {region: "koreasouth", zones: []},
                    {region: "francecentral", zones: []},
                ...
                'Google CloudEngine': [
                    ...
                    {
                        region: 'southamerica-east1 (South America)',
