...
exports.up = function (db, next) {
    ...
    const list = [
      ...
      {name: 'Oracle MySQL', family: ['Database'], tags: ['oracle', 'relational'], owner: false},
      {name: 'Enterprise MySQL', family: ['Database'], tags: ['oracle', 'relational'], owner: false},
      {name: 'MariaDB', family: ['Database'], tags: ['relational'], owner: false},
      {name: 'Percona', family: ['Database'], tags: ['relational'], owner: false},
      {name: 'Aurora (AWS)', family: ['Database'], tags: ['relational', 'aws'], owner: true},
      ...
      {name: 'Oracle Database', family: ['Database'], tags: ['oracle', 'relational'], owner: false},
      {name: 'Oracle NoSQL', family: ['Database'], tags: ['oracle'], owner: false},
      {name: 'Oracle Coherence', family: ['Database'], tags: ['oracle'], owner: false},
