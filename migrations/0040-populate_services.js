...
exports.up = function (db, next) {
    ...
    const list = [
        ...
        {
            name: 'Kubernetes',
            family: ['Loadbalance', 'ContainerOrchestration'],
            tags: ['oss', 'container'],
            owner: false
        },
        {
        ...
        {
            name: 'Google Cloud (K8S)',
            family: ['ContainerOrchestration', 'Repository'],
            tags: ['gcloud', 'container'],
            owner: true
        },
        {
        ...
        {name: 'MailChimp', family: ['SMTP'], tags: [], owner: true},
        {name: 'SendGrid', family: ['SMTP'], tags: [], owner: true},
        {name: 'SES (AWS)', family: ['SMTP'], tags: ['aws'], owner: true},
        {name: 'Mailgun', family: ['SMTP'], tags: [], owner: true},
        {name: 'Postmark', family: ['SMTP'], tags: [], owner: true},
        {name: 'Sender', family: ['SMTP'], tags: [], owner: true},
        {name: 'Mailjet', family: ['SMTP'], tags: [], owner: true},
        {name: 'Elastic Email', family: ['SMTP'], tags: [], owner: true},
        {name: 'Userfox', family: ['SMTP'], tags: [], owner: true},
        {name: 'Lob', family: ['SMTP'], tags: [], owner: true},
        {name: 'outMail', family: ['SMTP'], tags: [], owner: true},
        {name: 'SendBulls', family: ['SMTP'], tags: [], owner: true},
        {name: 'GetResponse', family: ['SMTP'], tags: [], owner: true},
        {name: 'Constant Contact', family: ['SMTP'], tags: [], owner: true},
        {name: 'Emma', family: ['SMTP'], tags: [], owner: true},
        {name: 'iContact', family: ['SMTP'], tags: [], owner: true},
        {name: 'SendInBlue', family: ['SMTP'], tags: [], owner: true},
        {name: 'Exact Target', family: ['SMTP'], tags: [], owner: true},
        {name: 'Locaweb SMTP', family: ['SMTP'], tags: ['locaweb'], owner: true},


        {name: 'Postfix', family: ['SMTP'], tags: ['oss'], owner: false},
        {name: 'Exim', family: ['SMTP'], tags: ['oss'], owner: false},
        {name: 'Sendmail', family: ['SMTP'], tags: ['oss'], owner: false},
        {name: 'Haraka', family: ['SMTP'], tags: [], owner: false},
        {name: 'Courier-MTA', family: ['SMTP'], tags: ['oss'], owner: false},
        {name: 'Microsoft SMTP Server (Exchange)', family: ['SMTP'], tags: ['microsoft'], owner: false},
        {name: 'PowerMTA', family: ['SMTP'], tags: [], owner: false},
        {name: 'OpenSMTPD', family: ['SMTP'], tags: [], owner: false},
        {name: 'Dragonfly Mail Agent', family: ['SMTP'], tags: [], owner: false},
        {name: 'sSMTP', family: ['SMTP'], tags: [], owner: false},
        {name: 'MailerQ', family: ['SMTP'], tags: [], owner: false},
        {name: 'Hectane', family: ['SMTP'], tags: [], owner: false},
        {name: 'BulkMTA', family: ['SMTP'], tags: [], owner: false},
        ...
        {name: 'SkyDNS', family: ['ServiceDiscovery', 'DNS'], tags: [], owner: false},
        ...
        {name: 'Artifactory (jFrog)', family: ['Repository'], tags: ['registry'], owner: true},
        ...
        {name: 'Route53 (AWS)', family: ['DNS'], owner: true},
        ...
        {name: 'NFS', family: ['NAS'], tags: [], owner: false},
        {name: 'GlusterFS', family: ['NAS'], tags: [], owner: false},
        {name: 'CephFS', family: ['NAS'], tags: [], owner: false},
        {name: 'EFS (AWS)', family: ['NAS'], tags: [], owner: true},
