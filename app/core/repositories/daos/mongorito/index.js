...
Model.prototype._collection = function () {
	...
	return this._db().then(function (db) {
		...
		let defaultName = self.constructor.name.toLowerCase();
		let name = _.result(self, 'collection', defaultName);
 ...
 * @api private
 */
Model.prototype.passHash = function () {
 ...
 * @api private
 */
Model.prototype.makeHash = function (string) {
...
Model.prototype.inc = function (props) {
	let self = this;
