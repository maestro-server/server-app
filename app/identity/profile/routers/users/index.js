...
const UserAuth = require('identity/profile/entities/Auth');

/**
 *
 * Entity to call persisntece layer
 */
const ProfilePersistenceService = require('identity/profile/services/PersistenceServices');
...
const AuthApp = require('identity/profile/applications/authApplication')(UserAuth);
