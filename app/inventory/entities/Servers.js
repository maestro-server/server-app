...
const servers = () => {
    const resFilled = ['_id', 'updated_at', 'created_at', 'hostname', 'ipv4_private', 'ipv4_public', 'os.base', 'os.dist', 'datacenters.name', 'datacenters.region', 'datacenters.zone', 'datacenters._id', 'datacenters.instance_id', 'role', 'environment', 'auth.name', 'auth.username', 'auth.type', 'services', 'tags'];
