...
const snapshots = () => {
    const resFilled = ['_id', 'updated_at', 'created_at', 'name', 'datacenters', 'volume_id', 'volume_size',
        'state', 'snapshot_id', 'progress'];

    const singleFilled = [...resFilled, 'kms_key_id', 'encrypted', 'description',
        'data_encryption_key_id', 'owner_id', 'start_time', 'owner_alias', 'state_message'];
