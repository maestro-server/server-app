...
describe('e2e volumes', function () {
     ...
     * @description I like to add new role into my Myvolumes
     */
    ...
    describe('update roles', function () {
        it('Exist roles - update role volume', function (done) {
            request(mock)
                .put('/volumes/' + volumes[0]._id + "/roles")
    ...
    describe('update single roles', function () {
        it('Exist roles - update role volume', function (done) {
            request(mock)
                .put('/volumes/' + volumes[0]._id + "/roles/" + friend._id)
    ...
    describe('delete roles', function () {
        it('Exist roles - delete role', function (done) {
            request(mock)
                .delete('/volumes/' + volumes[0]._id + "/roles/" + friend._id)
                .set('Authorization', `JWT ${user.token}`)
                .expect(204)
                .end(function (err) {
                    if (err) return done(err);
